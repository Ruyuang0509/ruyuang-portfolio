...
export const TEXT_RULES = [
  ...
  { ruleId: "text.audit.unsupported-extension", pattern: /目前不能延伸的主張/u },
  { ruleId: "text.audit.currently-cannot-prove", pattern: /目前不能證明/u },
  { ruleId: "text.audit.applicant-record-support", pattern: /申請者提供的紀錄支持/u },
  { ruleId: "text.audit.no-public-finished-video", pattern: /目前公開頁沒有成片/u },
  { ruleId: "text.audit.participation-not-award", pattern: /參賽不代表得獎/u },
  { ruleId: "text.audit.page-does-not-claim", pattern: /本頁不主張/u },
  { ruleId: "text.audit.missing-source-no-inference", pattern: /原始紀錄未列出，不另行推測/u },
  { ruleId: "text.audit.applicant-provided-only", pattern: /本頁僅有申請者提供/u },
  { ruleId: "text.audit.unapproved-publication-decision", pattern: /未經發布決策確認/u },
  { ruleId: "text.audit.verifiable-materials", pattern: /可核對材料/u },
  { ruleId: "text.audit.current-description", pattern: /目前怎麼描述/u },
  { ruleId: "text.audit.source-video-limitations", pattern: /原始影片限制/u },
  { ruleId: "text.audit.formal-pages-url", pattern: /正式\s*GitHub Pages\s*專案網址/iu },
  {
