...
1. **聲響科技研究主線。** 最終網站要清楚回答「視覺、聲音與互動如何形成可理解、可操作、可測試的跨感官回饋」。
...
- **理想審查旅程：** Hero 建立聲響研究問題 → 定位說明過往能力如何支援 → 操作 Web Audio → 查看尚未驗證的計畫 → 閱讀工具學習邊界 → 用 AI／資料視覺化案例驗證跨域能力。
- **成功行為：** 審查者能清楚辨識目前真正做成的東西、尚未完成的研究、個人角色及下一階段研究方向。
- **動作品質：** 3D 提供氛圍，聲音 mapping 提供核心互動；兩者都應平順、可停止、可回退且不搶走閱讀控制。
- **完成標準：** 不只 schema／畫面完整，還需要真實 participant evidence、可公開 Pure Data／REAPER artifact 或明確不納入、媒體字幕／描述與 production sharing setup。

以上為從 code、copy 與治理文件推論的產品意圖，不是已簽核 PRD。

## Assumptions requiring stakeholder confirmation

- 使用者提供的提示詞已將國立臺南藝術大學聲響科技研究所列為目標評審；仍需確認當年度官方系所名稱、招生要求、申請年度、截止日與是否加入校名專屬內容。
- 是否加入公開 email、履歷、社群、作品下載或其他真正轉換；目前明文沒有聯絡資料。
- Pure Data／REAPER 最終是否必須成為正式作品證據，或只作研究準備背景。
- AI 文學故事 MV 的成片與流程已可公開；仍需由申請者決定是否補完整 Prompt Template、素材來源治理與學生／教師測試，再決定是否提高策展比重。
