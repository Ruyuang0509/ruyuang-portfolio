      ...
      <div className="mx-auto grid max-w-7xl gap-12">
        <div className="grid gap-5 md:grid-cols-[0.36fr_0.64fr] md:gap-16">
          ...
          <div className="grid gap-5">
            ...
            <p className="zh-copy-wide text-[color:var(--theme-muted)]">Web Audio 已能直接操作；Pure Data 從 2026 年 7 月 24 日開始練習，REAPER 已完成安裝，但尚未形成工程或聲音輸出。這一區把可操作作品與正在累積的聲音工具經驗放在同一條學習路線上。</p>
            <a className="interactive-link chip-text w-fit rounded-full border border-[color:var(--theme-line)] px-5 py-3 text-sm font-extrabold" href="#project-index">接著看代表作品</a>
          </div>
        </div>
