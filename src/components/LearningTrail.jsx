      ...
      <div className="mx-auto grid max-w-7xl gap-12">
        <div className="grid gap-5 md:grid-cols-[0.36fr_0.64fr] md:gap-16">
          ...
          <div className="grid gap-5">
            ...
            <p className="zh-copy-wide text-[color:var(--theme-muted)]">Web Audio 已能直接操作；Pure Data 從 2026/07/24 開始練習，REAPER 則從基本路由與效果鏈起步。這一區把可操作作品與正在累積的聲音工具經驗放在同一條學習路線上。</p>
