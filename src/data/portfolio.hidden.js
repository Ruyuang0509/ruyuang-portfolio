export const hiddenProjectCaseStudies = [
  {
    ...
    testing: {
      ...
      status: "尚未進行正式觀眾驗證；目前為 draft-only 研究構想。",
      metrics: [],
      insights: [],
      learningOutcomes: [],
      plannedMethods: ["記錄觀眾停留節點、路徑理解與記憶線索回想。"],
    },
    reflection: {
    ...
    seo: {
      title: "沉浸式記憶地圖 | RU / YUAN",
      description: "以空間、影像、聲音與互動探索構成的研究型作品案例。",
    },
  },
];
// Draft-only case data intentionally carries no media references until real evidence exists.
