...
export const projectInternalNotes = {
  ...
  "generative-interface-study": {
    ...
    evidenceReadiness: {
      ...
      rightsPublicSummaryPath: "docs/evidence/hamlet-rights-evidence-public.md",
      applicantAttestationPath: "docs/evidence/hamlet-applicant-attestation.md",
      ...
      openGates: ["original-prompt-log", "scene-generation-records", "formative-study-records", "applicant-rights-attestation"],
    },
    rightsReview: {
      status: "pendingApplicantConfirmation",
      publicationGate: "requiresApplicantAttestation",
      applicantAttestation: {
        confirmed: false,
        confirmedBy: null,
        confirmedAt: null,
        evidenceRef: "hamlet-applicant-attestation-v1",
      },
