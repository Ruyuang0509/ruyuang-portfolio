...
export const representativeWorks = [
  {
    ...
    summary:
      "《畫本》是我第一次完整面對故事構思、攝影與剪輯流程的短劇作品。從畫面取材、節奏安排到聲畫配合，我開始理解一段看似自然的影像，背後需要反覆選擇與修正。這次製作也成為從觀看作品轉向拆解作品如何成立的起點。",
    purpose: "以原創短劇練習把故事構思轉成可拍攝、可剪輯的聲畫敘事。",
    tools: ["Samsung S24 Ultra", "DaVinci Resolve"],
    roles: ["故事構思", "攝影", "剪輯"],
    highlights: ["原創影音敘事", "攝影取材", "剪輯節奏", "自主學習"],
    reflection:
      "這次製作讓我第一次從完成作品回看故事、鏡位與剪輯如何互相影響，也成為後續整理影音敘事方法的起點。",
    materialsNote:
...
export const supportingEvidenceLinks = [
  {
    ...
    title: "AI 文學故事 MV",
    description:
      "觀看 40 秒成片、雙語字幕與八幕敘事設計，並了解生成與人工判斷的分工；目前非營利使用範圍已透過 applicant attestation（申請人聲明）完成具名確認並通過發布檢查，教學成效仍未驗證。",
    target: "#generative-interface-study",
  },
  {
    label: "資料敘事",
    title: "資料視覺化案例",
    description: "從案例蒐集、內容選擇到影片編排，查看資料故事的整理方法與閱讀節奏。",
...
export const learningRoadmap = [
  ...
  },
  {
    ...
    note: "Pure Data 開始日期：2026 年 7 月 24 日。",
  },
  {
    status: "下一階段",
